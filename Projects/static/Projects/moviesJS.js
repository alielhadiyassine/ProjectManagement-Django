...
function runCategories() {
    ...
    document.getElementById("moviesSubcategories").onchange = changeSubcategory;
...
function SearchForItem() {
    ...
    var current_category = $("moviesSubcategories").value;
    ...
    if (typed_input != "") {
        ...
        for (let i = 0; i < tenDivs.length; i++) { //loop over the 10 divs
            ...
            if (current_category == "") {
                ...
                if (smallDivTitle.includes(typed_input)) { //check if input text is included
                    ...
                    document.getElementsByClassName("nomoviesFound")[0].style.display = "none";
        ...
        if (showTopSellingTitle == false) {
            ...
            //var bla = document.getElementsByClassName("nomoviesFound")[0].innerHTML;

            //alert(bla);

            document.getElementsByClassName("nomoviesFound")[0].style.display = "block";

            //document.getElementsByClassName("nomoviesFound")[1].style.display = "none";

            //document.getElementsByClassName("nomoviesFound")[2].style.display = "none";  
        ...
        if (showNewReleasesTitle == false) {
            ...
            document.getElementsByClassName("nomoviesFound")[1].style.display = "block";
        ...
        if (showRecommendationsTitle == false) {
            ...
            document.getElementsByClassName("nomoviesFound")[2].style.display = "block";
...
function changeSubcategory() { //change subcategory after user selects it
    ...
    var userSubCategory = document.getElementById("moviesSubcategories").value;
    ...
    if (userSubCategory != "") {
        ...
        if (userSubCategory == "Action and Adventure") { weNeed = "actionMovie"; } //e.g. 'Biography' is the dropdown's value, but biographyBook is the div's class

        if (userSubCategory == "Animation") { weNeed = "animationMovie"; }

        if (userSubCategory == "Comedy") { weNeed = "comedyMovie"; }

        if (userSubCategory == "Drama") { weNeed = "dramaMovie"; }

        if (userSubCategory == "Family") { weNeed = "familyMovie"; }

        if (userSubCategory == "Horror") { weNeed = "horrorMovie"; }
