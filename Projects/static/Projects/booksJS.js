...
function runCategories() {
    ...
    document.getElementById("booksSubcategories").onchange = changeSubcategory;
    ...
    $("Currency").value = "LBP L.L";

    $("booksSubcategories").value = "";
...
function SearchForItem() {
    ...
    var current_category = $("booksSubcategories").value;
    ...
    if (typed_input != "") {
        ...
        for (let i = 0; i < tenDivs.length; i++) { //loop over the 10 divs
            ...
            var smallDiv = tenDivs[i].parentNode;
            ...
            if (window.getComputedStyle(smallDiv).display === "none") {
                continue
              }
            else {
                if (smallDivTitle.includes(typed_input)) { //check if input text is included
                    ...
                    document.getElementsByClassName("noBooksFound")[0].style.display = "none";
            ...
            if (current_category == "") {
                ...
                if (smallDivTitle.includes(typed_input) && smallDivSubcategory.classList.contains(current_category)) { //check if input text is included
        ...
        if (showTopSellingTitle == false) {
            ...
            //var bla = document.getElementsByClassName("noBooksFound")[0].innerHTML;

            //alert(bla);

            document.getElementsByClassName("noBooksFound")[0].style.display = "block";

            //document.getElementsByClassName("noBooksFound")[1].style.display = "none";

            //document.getElementsByClassName("noBooksFound")[2].style.display = "none";  
        ...
        if (showNewReleasesTitle == false) {
            ...
            document.getElementsByClassName("noBooksFound")[1].style.display = "block";
        ...
        if (showRecommendationsTitle == false) {
            ...
            document.getElementsByClassName("noBooksFound")[2].style.display = "block";
        ...
        for (let i = 0; i < allSmallDivs.length; i++) {
            ...
            if (current_category == "") {
            allSmallDivs[i].parentNode.style.display = "inline";
            }
            else {
                if (allSmallDivs[i].classList.contains(weNeed)) {
                    allSmallDivs[i].parentNode.style.display = "inline";
                }
                else {
                    allSmallDivs[i].parentNode.style.display = "none";
                }
            }
...
function changeSubcategory() { //change subcategory after user selects it
    ...
    var userSubCategory = document.getElementById("booksSubcategories").value;
    ...
    if (userSubCategory != "") {
        ...
        if (userSubCategory == "Biography") { weNeed = "biographyBook"; } //e.g. 'Biography' is the dropdown's value, but biographyBook is the div's class

        if (userSubCategory == "Business") { weNeed = "businessBook"; }

        if (userSubCategory == "Children") { weNeed = "childrenBook"; }

        if (userSubCategory == "Fiction") { weNeed = "fictionBook"; }

        if (userSubCategory == "SelfHelp") { weNeed = "selfHelpBook"; }

        if (userSubCategory == "Thrillers") { weNeed = "thrillerBook"; }
    ...
    else { //all categories are needed, category = ALL
        ...
        for (let i = 0; i < allSmallDivs.length; i++) {
            ...
            allSmallDivs[i].parentNode.style.display = "inline";
                ...
                var smallDivTitle = allSmallDivs[i].getElementsByClassName("title")[0].innerText.toLowerCase();
                if (smallDivTitle.includes(typed_input)) {
                    allSmallDivs[i].parentNode.style.display = "inline";
                }
                else {
