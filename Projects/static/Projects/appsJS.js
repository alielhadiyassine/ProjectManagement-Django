...
function runCategories() {
    ...
    document.getElementById("appsSubcategories").onchange = changeSubcategory;
    ...
    if (typed_input != "") {
        ...
        for (let i = 0; i < tenDivs.length; i++) { //loop over the 10 divs
            ...
            if (smallDivTitle.includes(typed_input)) { //check if input text is included
                ...
                document.getElementsByClassName("noappsFound")[0].style.display = "none";
            }
            else {
        ...
        if (showTopSellingTitle == false) {
            //var bla = document.getElementsByClassName("noappsFound")[0].innerHTML;
            //alert(bla);
            document.getElementsByClassName("noappsFound")[0].style.display = "block";
            //document.getElementsByClassName("noappsFound")[1].style.display = "none";
            //document.getElementsByClassName("noappsFound")[2].style.display = "none";  
        }
        ...
        if (showNewReleasesTitle == false) {
            //document.getElementsByClassName("noappsFound")[0].style.display = "none";
            document.getElementsByClassName("noappsFound")[1].style.display = "block";
            //document.getElementsByClassName("noappsFound")[2].style.display = "none"; 
        }
        ...
        if (showRecommendationsTitle == false) {
            //document.getElementsByClassName("noappsFound")[0].style.display = "none";
            //document.getElementsByClassName("noappsFound")[1].style.display = "none";
            document.getElementsByClassName("noappsFound")[2].style.display = "block";
        }
...
function changeSubcategory() { //change subcategory after user selects it
    ...
    var userSubCategory = document.getElementById("appsSubcategories").value;

    if (userSubCategory != "") {

        //what we need to look for: apps
        var weNeed;
        if (userSubCategory == "Lifestyle") { weNeed = "lifestyleApp"; }
        if (userSubCategory == "Photography") { weNeed = "photographyApp"; }
        if (userSubCategory == "Productivity") { weNeed = "productivityApp"; }
        if (userSubCategory == "Social") { weNeed = "socialApp"; }
        if (userSubCategory == "Entertainment") { weNeed = "entertainmentApp"; }
        if (userSubCategory == "Education") { weNeed = "educationApp"; }
        if (userSubCategory == "Shopping") { weNeed = "shoppingApp"; }
        if (userSubCategory == "Music") { weNeed = "musicApp"; }
